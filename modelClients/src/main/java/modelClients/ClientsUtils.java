...
public class ClientsUtils {
	...
	public static String generateJsonStringResponse(HashMap<String, Object> mapObject){
		try{
			return ClientsUtils.generateJsonObject().writeValueAsString(mapObject);
	...
	public static ClientsModel generateJsonObjectResponse(String jsonString) {
		try {
			System.out.println(jsonString);
			return ClientsUtils.generateJsonObject().readValue(jsonString, ClientsModel.class);
